...
export const DocumentsSalesService = {
  ...
  async confirm(id: string): Promise<Document> {
    return $fetch(`/api/backend/documents/sales/${id}/confirm`, {
      method: 'PATCH' as any
    })
  },

  async cancel(id: string): Promise<Document> {
    return $fetch(`/api/backend/documents/sales/${id}/cancel`, {
      method: 'PATCH' as any
    })
  },

  async accept(id: string): Promise<Document> {
    return $fetch(`/api/backend/documents/sales/${id}/accept`, {
      method: 'PATCH' as any
    })
  },

  async deliver(id: string): Promise<Document> {
    return $fetch(`/api/backend/documents/sales/${id}/deliver`, {
      method: 'PATCH' as any
    })
  },

  async partialDeliver(id: string, items: { document_item_id: string; quantity: number }[]): Promise<Document> {
    return $fetch(`/api/backend/documents/sales/${id}/partial-deliver`, {
      method: 'PATCH' as any,
      body: { items }
    })
  },
  ...
  async partialInvoice(id: string, items: { document_item_id: string; quantity: number }[]): Promise<Document> {
    return $fetch(`/api/backend/documents/sales/${id}/partial-invoice`, {
      method: 'PATCH' as any,
      body: { items }
    })
  },
  ...
  async changeStatus(id: string, status: number): Promise<Document> {
    return $fetch(`/api/backend/documents/sales/${id}/status`, {
      method: 'PATCH' as any,
      body: { status }
    })
  },
  ...
  async remove(id: string): Promise<void> {
    return $fetch(`/api/backend/documents/sales/${id}`, { method: 'DELETE' as any })
  },
  ...
  async generateFromAllTrips(): Promise<{
    ...
    return $fetch('/api/backend/documents/sales/generate', {
      method: 'POST' as any
    })
  },
  ...
  async getCompletedTripsPending(): Promise<{
    ...
    return $fetch('/api/backend/documents/sales/completed-trips-pending')
  },
  ...
  async generateFromTrips(payload: {
    ...
    return $fetch('/api/backend/documents/sales/generate-from-trips', {
      method: 'POST' as any,
      body: payload
    })
  },
  ...
  async generateFromTrip(tripId: string): Promise<{ created: number; skipped: number }> {
    return $fetch(`/api/backend/documents/sales/generate-from-trip/${tripId}`, {
      method: 'POST' as any,
    })
  }
}
